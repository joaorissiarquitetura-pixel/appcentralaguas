...
class Settings:
    ...
    WHATSAPP_RESET_TEMPLATE_NAME: str
    WHATSAPP_RESET_TEMPLATE_LANGUAGE: str
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        WHATSAPP_RESET_TEMPLATE_NAME=os.getenv("WHATSAPP_RESET_TEMPLATE_NAME", ""),
        WHATSAPP_RESET_TEMPLATE_LANGUAGE=os.getenv("WHATSAPP_RESET_TEMPLATE_LANGUAGE", "pt_BR"),
